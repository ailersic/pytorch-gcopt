...
class FashionMNISTClass(ContNet):
    def __init__(self, logcontvar0: float, loggradvar0: float, cont_lr: float, cont_reg: float, warmup_epochs: int):
        ...
        self.datasetname = 'FashionMNIST_Conv'
        self.epochs = 20

        self.dataset = FashionMNIST(os.getcwd(), download=True, transform=transforms.ToTensor())
        ...
        self.net = nn.Sequential(
                                nn.Conv2d(1, 128, 3, padding=1), activ,
                                nn.Conv2d(128, 64, 3, padding=1), activ,
                                nn.Conv2d(64, 32, 3, padding=1), activ,
                                nn.Conv2d(32, 16, 3, padding=1), activ,
                                nn.Conv2d(16, 8, 3, padding=1), activ,
                                nn.Conv2d(8, 4, 3, padding=1), activ,
                                nn.Conv2d(4, 2, 3, padding=1), activ,
                                nn.Conv2d(2, 1, 3, padding=1), activ,
