...
class DemoRegress(ContNet):
    def __init__(self, logcontvar0: float, loggradvar0: float, cont_lr: float, cont_reg: float, warmup_epochs: int):
        ...
        self.n_layers = 2
        self.datasetname = f'DemoRegWDL{self.n_layers}'
        self.epochs = 100

        self.dataset = DemoRegDataset("reg_data_n10_s100000.csv")
    ...
    def configure_optimizers(self):
        ...
        optimizer = torch.optim.Adam([{'params': self.net.parameters(), 'weight_decay': 1e-4},
